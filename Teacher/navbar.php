...
<head>
  ...
  <title>DNHS Attendance MS QR Code | Dashboard</title>
...
<div class="wrapper">
 ...
 -->
          ...
          <li class="nav-header text-secondary">HANDLED SUBJECTS</li>
          <li class="nav-item">
            <a href="subjects_handled.php" class="nav-link"><i class="fa-solid fa-book"></i><p>&nbsp;&nbsp; Subjects handled</p></a>
          </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="students_backup.php" class="nav-link"><i class="fa-solid fa-window-restore"></i><p>&nbsp;&nbsp; Restore students</p></a>
              </li>
            </ul>
          </li>
