<title>Attendance MS QR Code | Attendance Count</title>
                ...
                <div class="row bg-light">
                  <div class="col-6">
                      <div class="form-group">
                          ...
                          <select class="select2" data-placeholder="Shelf location" id="shelf" style="width: 100%;" onchange="myFunction(this.value)" required>
                   ...
                   <div class="col-5">
                      <div class="form-group">
                        <form method="POST">
                          ...
                          <select class="select2" data-placeholder="Select Subject" id="subject" style="width: 100%;" onchange="myFunctionthree()" required>
                          <!-- <select class="select2" multiple="multiple" data-placeholder="Shelf location" style="width: 100%;" name="shelf-location"> -->
