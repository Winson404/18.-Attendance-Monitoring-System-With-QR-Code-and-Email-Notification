    ...
    <div class="modal-content">
      <div class="modal-header bg-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-qrcode"></i> Scan QR Code here</h5>
          <a type="button" class="close" href="attendance_ModalNotOnLoad.php?section_Id=<?php echo $section_Id; ?>&&assignId=<?php echo $assignId; ?>"><i class="fa-solid fa-circle-xmark"></i></a>
