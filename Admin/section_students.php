              ...
              <div class="card-body">
                 ...
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody id="users_data">
                    <tr>
                      <?php 
                        $fetch = mysqli_query($conn, "SELECT *, COUNT(student_Id) AS stud FROM students JOIN section ON students.student_section_Id=section.section_Id JOIN grade ON section.section_grade_Id=grade.grade_Id WHERE DELETED='False' GROUP BY student_section_Id ORDER BY grade");
