<title>Attendance MS QR Code | Admin profile</title>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="updateprofile">
                      ...
                      <div class="form-group row">
                        <label for="Date of birth" class="col-sm-2 col-form-label">Date of birth</label>
                        <div class="col-sm-10">
                          <input type="date" class="form-control" name="dob" placeholder="Date of birth" required id="update_txtbirthdate" onkeyup="update_getAgeVal(0)" onblur="update_getAgeVal(0);" onchange="update_getAgeVal(0);" value="<?php echo $row['dob']; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="age" class="col-sm-2 col-form-label">Age</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control bg-white" placeholder="Select DOB first" required id="update_txtage" readonly value="<?php echo $row['age']; ?>">
