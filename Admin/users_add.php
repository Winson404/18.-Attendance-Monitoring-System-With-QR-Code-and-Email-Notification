  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user-plus"></i> Add teacher</h5>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm"  placeholder="ID Number" name="idnumber" required>
              </div>
          </div>
          ...
          <div class="col-lg-2">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control bg-white form-control-sm" placeholder="Select DOB first" required id="txtage" readonly>
