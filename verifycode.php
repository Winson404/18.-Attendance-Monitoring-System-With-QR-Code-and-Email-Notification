<title>Attendance MS QR Code | Verify code</title>
<?php 
  include 'navbar.php'; 
?>

  <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" style="background-image: url('images/login.jpg');background-position: cover;background-repeat: no-repeat;background-size: cover;">
    <div class="content">
      <div class="container">
      ...
      if($check_code == NULL) {
        ...
        if($insert_code) {
          ...
          try {
            ...
            $mail->SMTPAuth = true;                             
            $mail->Username = 'dnhsattendancems@gmail.com';     
            $mail->Password = 'mspjwatotluhtggi';              
            ...
            //Send Email
            $mail->setFrom('dnhsattendancems@gmail.com');

            //Recipients
            $mail->addAddress($email);              
            $mail->addReplyTo('dnhsattendancems@gmail.com');
